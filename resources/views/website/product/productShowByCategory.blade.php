                            ...
                            <div class="ec-sb-block-content">
                                <ul>
                                    <li>
                                        @foreach ($categories as $category)
                                            <div class="ec-sidebar-block-item">
                                                <a href="{{route('category.show-product',['id' => $category->id])}}">{{$category->name}}</a><span class="checked"></span>
                                            </div>
                                        @endforeach
                                    </li>
                                </ul>
                            ...
                            <div class="ec-sb-block-content">
                                <ul>
                                    <li>
                                        @foreach ($brands as $brand)
                                            <div class="ec-sidebar-block-item">
                                                <a href="{{route('brand.show-product',['id' => $brand->id])}}">{{$brand->name}}</a><span class="checked"></span>
                                            </div>
                                        @endforeach
                                    </li>
                                </ul>
