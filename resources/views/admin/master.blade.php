                    ...
                    <div class="user-pro-body">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu animated flipInY">
                                <!-- text-->
                                <a href="{{ route('profile.show') }}" class="dropdown-item"><i class="ti-user"></i>
                                    My Profile</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            <div class="title-description-pair">
                ...
                <button type="button" class="remove-field btn btn-outline-danger">Remove</button>
            </div>
        `;
                $("#title-description-fields").append(newTitleDescriptionPair);

                // Initialize the WYSIWYG editor for the new textarea
                titleDescriptionCounter++;
            });

            $("#title-description-fields").on("click", ".remove-field", function() {
                $(this).parent().remove();
                titleDescriptionCounter--;
            });
            ...
            <div class="image">
                ...
                <input type="file" class="form-control is-valid" name="image[]" id="validationServer02" placeholder="Image">
        ...
        `;
                $("#image-field").append(newImageField);
                titleDescriptionCounter++;
            });

            $("#image-field").on("click", ".remove-field", function() {
                $(this).parent().remove();
                titleDescriptionCounter--;
            });
            $("#title-description-fields").on("focus", ".textarea_editor", function() {
