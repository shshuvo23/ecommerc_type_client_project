                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-md-6">
                                    <a href="{{route('admin.blog-edit', ['id' => $blog->id])}}" class="badge rounded-pill bg-info">Edit</a>
                                    <a href="{{route('admin.blog-delete', ['id' => $blog->id])}}" class="badge rounded-pill bg-info">Delete</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
