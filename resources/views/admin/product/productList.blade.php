                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-md-6">
                                    <a href="{{route('product.edit', ['id' =>$product->id])}}" class="badge rounded-pill bg-info">Edit</a>
                                    <a href="{{route('product.delete', ['id' =>$product->id])}}" class="badge rounded-pill bg-info">Delete</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
